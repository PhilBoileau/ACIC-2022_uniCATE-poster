...
\newcommand{\mysmallblock}[2]{\block[titleinnersep=1mm, linewidth=1mm]{{\small #1}}{#2}}
...
\begin{columns}
  ...
  \myblock{Conclusions}{
    ...
    procedures that control Type-I error rates. This estimator is implemented
    in the \texttt{uniCATE} \texttt{R} package available at
