...
\begin{columns}
  ...
  \myblock{Conclusions}{
    Predictive biomarker discovery in high-dimensions benefits from formal
    statistical inference procedures that control Type-I error rates. This
    estimator is implemented in the \texttt{uniCATE} \texttt{R} package
    available at \texttt{github.com/insightsengineering/uniCATE}.
  }
